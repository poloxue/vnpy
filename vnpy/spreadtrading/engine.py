...
class SpreadDataEngine:
    ...
    def add_spread(
        ...
        for leg_setting in leg_settings:
            ...
            variable_directions[variable] = int(leg_setting["trading_direction"])
            trading_multipliers[vt_symbol] = int(leg_setting["trading_multiplier"])
...
class SpreadStrategyEngine:
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        path: Path = Path.cwd().joinpath("strategies/spread")
        self.load_strategy_class_from_folder(path, "strategies.spread")
