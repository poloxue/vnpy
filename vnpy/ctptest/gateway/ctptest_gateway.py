...
class CtptestGateway(BaseGateway):
    ...
    def connect(self, setting: dict) -> None:
        """连接交易接口"""
        userid: str = setting["username"]
        password: str = setting["password"]
        brokerid: str = setting["brokerid"]
        td_address: str = setting["td_address"]
        md_address: str = setting["md_address"]
        appid: str = setting["appid"]
        auth_code: str = setting["auth_code"]
...
class CtptestTdApi(TdApi):
    ...
    def onRtnTrade(self, data: dict) -> None:
        ...
        trade: TradeData = TradeData(
            ...
            direction=DIRECTION_CTP2VT[data["Direction"]],
            offset=OFFSET_CTP2VT.get(data["OffsetFlag"], Offset.NONE),
            price=data["Price"],
            volume=data["Volume"],
            datetime=dt,
            gateway_name=self.gateway_name,
